/** Совпадает с правилами на сервере: только официальный Trade URL Steam. */
...
/** Тот же текст, что `STEAM_TRADE_URL_INVALID` на сервере. */
export const STEAM_TRADE_URL_ERROR =
  "Некорректная ссылка Steam Trade URL. Скопируйте её из профиля Steam.";
